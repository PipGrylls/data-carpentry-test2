...
> > levels = c(“female”, “male”, “undetermined”)) plot(sex){: .solution}
...
> > ifelse(weight \<= mean(weight, na.rm = TRUE), 1, 2)){: .solution}
> 
...
> > ## Solution
> > 
> > surveys %\>% count(plot\_type){: .solution}
> 
...
> > max(hindfoot\_length), n = n() ){: .solution}
> 
...
> > = ‘year’, values\_to = ‘n\_genera’){: .solution}
> 
...
Page built on: 📆 2022-01-11 ‒ 🕢 13:18:50
