...
> > > plot(surveys$hindfoot\_length) {: .solution}{: .solution}
...
> > > year, sex, weight) {: .solution}{: .solution}
...
> > > select(species\_id, hindfoot\_cm) {: .solution}{: .solution}
...
> > > ## Solution
> > > 
> > > surveys %\>% count(plot\_type) {: .solution}{: .solution}
> 
...
> > > max(hindfoot\_length), n = n() ) {: .solution}{: .solution}
> 
...
> > > weight) %\>% arrange(year) {: .solution}{: .solution}
...
> > > head(surveys\_wide\_genera) {: .solution}{: .solution}
> 
...
> > > names\_to = ‘year’, values\_to = ‘n\_genera’) {: .solution}{:
> > > .solution}
> 
...
Page built on: 📆 2022-01-11 ‒ 🕢 13:38:24
