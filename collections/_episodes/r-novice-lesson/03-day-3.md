...
> cheat sheet](https://ggplot2.tidyverse.org/) {.challenge}
...
> > 
> {: .solution}
>  ggplot(data = surveys\_complete, {: .solution} mapping
> > = aes(x = species\_id, y = weight)) + 
> {: .solution}
> 
...
>     error bars, pointrange, deciles, quintiles {.challenge}
...
> > .solution} group\_by(year, species\_id) %\>% 
> {: .solution}
> 
