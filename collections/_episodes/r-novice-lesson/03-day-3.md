...
> 
> > > ## Solution\> \>\> ggplot(data = surveys\_complete,
> > > 
...
> > > 
> > > group\_by(year, species\_id) %\>% summarize(avg\_weight =
> > > mean(weight)) ggplot(data = yearly\_weight, mapping = aes(x=year,
> > > y=avg\_weight)) + geom\_line() + facet\_wrap(vars(species\_id)) +
> > > theme\_bw() \`\`\`\> {: .solution}

<p style="text-align: right; font-size: small;">

Page built on: 📆 2022-01-11 ‒ 🕢 09:46:29
